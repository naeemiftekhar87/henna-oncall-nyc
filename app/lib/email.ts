        ...
        <div style="background: rgba(212,175,55,0.05); border: 1px solid rgba(212,175,55,0.15); border-radius: 12px; padding: 20px; margin-bottom: 24px;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 10px 0; color: #D4AF37; font-size: 17px; font-weight: 600; border-top: 1px solid rgba(255,255,255,0.05);">$${booking.price} <span style="color: #666; font-size: 12px; font-weight: 400;">(travel fee will be added based on location)</span></td>
            </tr>
          </table>
        </div>
